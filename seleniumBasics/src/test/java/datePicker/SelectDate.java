...
public class SelectDate {
	...
	public static void main(String[] args) {
		...
		WebElement prevMonth = wait.until(ExpectedConditions.presenceOfElementLocated(By.xpath("//span[@aria-label='Previous Month']")));

		jse.executeScript("arguments[0].setAttribute('style', 'border: 4px solid green;');", prevMonth);
		...
		WebElement dateToSelect = wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//div[@aria-label='Wed Feb 26 2025']")));
